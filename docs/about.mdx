...
Biometrics for All (B4LL) is a showcase project which enables mobile operators in emerging markets to test the use of biometric data for customer verification, which can be used to enhance on-boarding processes as well as ongoing usage of services by customers.
